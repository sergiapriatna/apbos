                            ...
                            <?php $no=1; foreach($data as $data): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url('mahasiswa/gantiStatus/'.$data->id.'/nonaktif')?>" class="btn btn-orange btn-sm"><i class="fa fa-times"></i> Blokir</a>
                                        <?php else: ?>
                                        <a href="<?= base_url('mahasiswa/gantiStatus/'.$data->id.'/aktif')?>" class="btn btn-success btn-sm"><i class="fa fa-check"></i> Aktifkan</a>
                                        <?php endif ?>
                                        ...
                                        <a href="<?= base_url('mahasiswa/hapus/'.$data->id)?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda Yakin Menghapus Data Ini?')"><i class="fa fa-trash"></i></a>
...
<div class="modal fade" id="editModal<?= $data2->id?>" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url('mahasiswa/edit/'.$data2->id)?>" method="post" enctype="multipart/form-data">
            <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="npm" class="form-control" value="<?= $data2->npm?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="" class="form-control-label">Tahun Angkatan</label>
                        <input type="text" name="tahunangkatan" class="form-control" value="<?= $data2->tahunangkatan?>">
                    </div>
                    <div class="form-group">
                        <label for="" class="form-control-label">Foto</label>
                        <input type="file" name="foto_new" class="form-control">
                        <input type="text" name="foto_old" class="form-control" value="<?= $data2->foto?>" hidden>
                    </div>
            </div>
...
<div class="modal fade" id="detailModal<?= $data->id?>" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="mediumModalLabel">Detail Data Mahasiswa</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col">
                        <img src="<?= base_url() ?>assets/img/mhs/<?= $data->foto ?>" class="img-thumbnail" alt="">
                    </div>
                    <div class="col">
                        <table class="table">
                            <tr>
...
<div class="modal fade" id="tambahModal" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url('mahasiswa/tambah')?>" method="post" enctype="multipart/form-data">
            <div class="modal-body">
                    <div class="form-group">
                        <label for="" class="form-control-label">Nama Lengkap</label>
                    ...
                    <div class="form-group">
                        <label for="" class="form-control-label">Tahun Angkatan</label>
                        <input type="text" name="tahunangkatan" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="" class="form-control-label">Foto</label>
